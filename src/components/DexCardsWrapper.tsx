    ...
    <div className="w-full max-w-[72rem] py-12">
      <div className="flex flex-col items-center justify-center gap-4">
        ...
        <div className="w-full flex flex-row justify-evenly items-center flex-wrap gap-8">
          ...
          <DexCard title={'Item Inventory'} description={'Search for items and view their effects and locations.'} cta={'Lookup Items'} className="from-[#a3eff9bf] to-[#98ccffbf]" href="items" badge="TODO" disabled/>
          <DexCard title={'Location Guide'} description={'View different locations, regions, and the Pokémon that can be found there.'} cta={'Lookup Locations'} className="from-[#ffcdffbf] to-[#d0b9f0bf]" href="locations" badge="TODO" disabled />
          <DexCard title={'Games Database'} description={'Learn about the different Pokémon games and their generations.'} cta={'Lookup Games'} className="from-[#f9eaccbf] to-[#f9d9ccbf]" href="games" badge="TODO" disabled />
        </div>
      </div>
    </div>
  )
